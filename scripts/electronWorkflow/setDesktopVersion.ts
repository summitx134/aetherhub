...
function updatePackageJson() {
  ...
  try {
    ...
    switch (releaseType) {
      case 'stable': {
        packageJson.productName = 'AetherHub';
        packageJson.name = 'lobehub-desktop';
        console.log('🌟 Setting as Stable version.');
        break;
      }
      case 'beta': {
        packageJson.productName = 'AetherHub-Beta'; // Or 'AetherHub-Beta' if preferred
      ...
      case 'nightly': {
        packageJson.productName = 'AetherHub-Nightly'; // Or 'AetherHub-Nightly'
