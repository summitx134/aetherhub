export default {
  ...
  'screen4.share.description':
    'Share anonymized usage data to help us improve AetherHub. This helps us understand how Agents are used and make them better.',
  ...
  'screen4.share.title': 'Help Improve AetherHub',
  ...
  'screen5.actions.signInCloud': 'Sign in to AetherHub Cloud',
  ...
  'screen5.methods.cloud.description':
    'Sign in with your AetherHub Cloud account to sync everything seamlessly',
  'screen5.methods.cloud.name': 'AetherHub Cloud',
  'screen5.methods.selfhost.description': 'Connect to your own AetherHub server instance',
