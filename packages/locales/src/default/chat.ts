export default {
  ...
  'heteroAgent.executionTarget.infoTooltip':
    'Pick a device and the agent uses it as its runtime environment — reading and writing files and operating the computer. Cloud sandbox is provided by AetherHub Marketplace.',
  ...
  'claudeCodeInstallGuide.reason': 'AetherHub could not start Claude Code: {{message}}',
  ...
  'codexInstallGuide.reason': 'AetherHub could not start Codex: {{message}}',
  ...
  'plus.search.appSearchDesc':
    'AetherHub optimized search service, delivering best retrieval results.',
  ...
  'sharePage.menu.goToAetherHub': 'Go to AetherHub',
  'sharePage.menu.more': 'More',
  'sharePage.menu.report': 'Report',
  'sharePageDisclaimer':
    "Shared by a user. The content reflects their views, not AetherHub's, and AetherHub takes no responsibility for it.",
