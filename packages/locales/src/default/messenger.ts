export default {
  ...
  'messenger.linkModal.instructions':
    'Open the bot, send /start, then tap "Link Account" to connect your AetherHub account.',
  ...
  'messenger.slack.connectModal.description':
    'You will be redirected to Slack to authorize the AetherHub workspace install.',
  ...
  'messenger.slack.connections.disconnectConfirm':
    'Disconnect the AetherHub bot from this Slack workspace? Existing user links will pause until you re-install.',
  ...
  'messenger.slack.installBlocked.suggestion':
    "DM @AetherHub on Slack to link your personal account — you don't need to install again. Or ask the original installer to disconnect this workspace first if you want to take over ownership.",
  'messenger.slack.installBlocked.title': 'Workspace already connected',
  'messenger.slack.installBlocked.withName':
    '"{{workspace}}" is already connected to AetherHub by another user.',
  'messenger.slack.installBlocked.withoutName':
    'This Slack workspace is already connected to AetherHub by another user.',
  ...
  'messenger.discord.connectModal.description':
    'Add the AetherHub bot to a Discord server you manage.',
  ...
  'messenger.discord.installBlocked.suggestion':
    "DM the AetherHub bot on Discord to link your personal account — you don't need to add the bot again. Or ask the original installer to remove this server in AetherHub Settings → Messenger before re-adding it.",
  ...
  'messenger.discord.installBlocked.withoutName':
    'This Discord server is already connected to AetherHub by another user.',
  ...
  'messenger.list.discord.description':
    'Chat with your AetherHub agents on Discord by DMing the AetherHub bot from any server.',
  'messenger.list.slack.description':
    'Chat with your AetherHub agents on Slack by DMing or mentioning @AetherHub in any workspace.',
  'messenger.list.telegram.description':
    'Chat with your AetherHub agents on Telegram, and choose which agent replies.',
  'messenger.setActiveFailed': 'Failed to set as active.',
  'messenger.setActiveSuccess': 'Active agent updated.',
  'messenger.subtitle':
    'Connect your account to the official AetherHub bot once. Pick which agent receives messages, switch any time from here or from the bot.',
  'messenger.title': 'Messenger',
  'messenger.unlinkConfirm':
    'Disconnect your {{platform}} account from AetherHub? Inbound messages will stop until you /start again.',
  ...
  'verify.confirm.conflict.description':
    'This {{platform}} account is already linked to AetherHub account {{email}}. Sign in to that account to manage the link, or unlink there before retrying.',
  ...
  'verify.confirm.fields.lobeHubAccount': 'AetherHub account',
  'verify.confirm.fields.platformAccount': '{{platform}} account',
  'verify.confirm.fields.workspace': 'Workspace',
  'verify.confirm.noAgents':
    "You don't have any agents yet. Create one in AetherHub, then come back to finish linking.",
  'verify.confirm.relink.description':
    'This AetherHub account is already linked to {{platform}} account {{account}}. To link a different {{platform}} account, disconnect the current one first in Settings → Messenger.',
  ...
  'verify.error.alreadyConsumed':
    'This link has already been used to connect an account. Sign in to that AetherHub account to manage the connection, or return to the bot and send /start again to issue a new link.',
  'verify.error.alreadyConsumedTitle': 'This link is already used',
  'verify.error.alreadyLinkedToOther':
    'This account is already linked to a different AetherHub account. Sign in to that account first.',
  ...
  'verify.error.unlinkBeforeRelink':
    'This AetherHub account is already linked to another account on this platform. Disconnect it in Settings → Messenger before linking a new one.',
  'verify.signInCta': 'Sign in to continue',
  'verify.signInRequired': 'Please sign in to AetherHub to confirm the link.',
