export default {
  ...
  'remoteServer.configDesc': 'Connect to the remote AetherHub server to enable data synchronization',
  ...
  'sync.lobehubCloud.title': 'AetherHub Cloud',
