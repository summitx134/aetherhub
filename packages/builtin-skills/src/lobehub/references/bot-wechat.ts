...
**Setup Guide:** https://aetherhub.local/docs/usage/channels/wechat
...
WeChat requires a QR code scan to link your account, which is only supported through the AetherHub Web UI:

1. Open your agent in AetherHub
