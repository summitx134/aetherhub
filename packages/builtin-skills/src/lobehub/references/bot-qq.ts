...
- AetherHub's \`lh bot connect\` handles the WebSocket gateway automatically
...
3. For AetherHub-hosted bots, contact support for the outbound IP range to whitelist
