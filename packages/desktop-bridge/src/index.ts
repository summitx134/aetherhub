 ...
 * originates from the Market service's own OAuth token, NOT from the user's AetherHub
 * session.  responseMeta checks this to suppress the X-Auth-Required header so the
 * desktop "re-login to AetherHub" modal is NOT shown; the Market OAuth flow handles it
