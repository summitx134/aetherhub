 ...
 * instrumentation, alongside AetherHub-specific (`lobehub.*`) extensions.
 *
...
// ---- lobehub.* (AetherHub-specific extensions) ----
...
/** Internal AetherHub tool source (`builtin` / `client` / `mcp` / `klavis` / `lobehubSkill`). */
