...
export interface AetherHubGroupMetaConfig {
  avatar?: string;
...
export interface AetherHubGroupChatConfig {
  allowDM?: boolean;
...
export type AetherHubGroupConfig = AetherHubGroupChatConfig;
...
export interface AetherHubGroupFullConfig {
  chat: AetherHubGroupChatConfig;
  meta: AetherHubGroupMetaConfig;
}
...
export interface NewChatGroup {
  ...
  config?: AetherHubGroupConfig | null;
