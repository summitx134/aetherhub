...
describe('LobeOpenRouterAI - custom features', () => {
  describe('Params Export', () => {
    ...
    it('should have constructorOptions with headers', () => {
      ...
      expect(params.constructorOptions.defaultHeaders['HTTP-Referer']).toBe('https://aetherhub.local');
      expect(params.constructorOptions.defaultHeaders['X-Title']).toBe('AetherHub');
    });
