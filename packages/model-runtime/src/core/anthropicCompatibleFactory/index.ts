...
/**
 * Build the default Anthropic Messages payload with AetherHub normalization.
 */
export const buildDefaultAnthropicPayload = async (
  ...
  // normalizeTemperature divides by 2 to map AetherHub's 0-2 range to Anthropic's 0-1 range.
