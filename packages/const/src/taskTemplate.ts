...
export type TaskTemplateSkillSource = 'klavis' | 'aetherhub';
...
export const taskTemplates: TaskTemplate[] = [
  ...
  },
  {
    ...
    requiresSkills: [{ provider: 'twitter', source: 'aetherhub' }],
  },
  {
  ...
  },
  {
    ...
    cronPattern: '0 20 * * 0',
    interests: ['writing', 'creator'],
    optionalSkills: [{ provider: 'notion', source: 'aetherhub' }],
  },
  ...
  },
  {
    ...
    cronPattern: '0 9 * * 1',
    interests: ['coding'],
    requiresSkills: [{ provider: 'github', source: 'aetherhub' }],
  },
  {
  ...
  },
  {
    ...
    cronPattern: '0 10 * * 1',
    interests: ['coding'],
    requiresSkills: [{ provider: 'vercel', source: 'aetherhub' }],
  },
  {
    ...
    requiresSkills: [{ provider: 'linear', source: 'aetherhub' }],
  },
  {
  ...
  },
  {
    ...
    cronPattern: '0 15 * * 5',
    interests: ['product'],
    requiresSkills: [{ provider: 'notion', source: 'aetherhub' }],
  },
