...
export const OFFICIAL_URL = 'http://localhost:9876';
export const OFFICIAL_SITE = 'http://localhost:9876';
export const OFFICIAL_DOMAIN = 'localhost';

export const OG_URL = '/og/og.webp?v=1';

export const GITHUB = 'https://github.com/summitx134/aetherhub';
...
export const FEEDBACK = 'https://github.com/summitx134/aetherhub/issues/new/choose';
export const PRIVACY_URL = urlJoin(OFFICIAL_SITE, '/privacy');
export const TERMS_URL = urlJoin(OFFICIAL_SITE, '/terms');

export const PLUGINS_INDEX_URL = 'http://localhost:9876';

export const MORE_MODEL_PROVIDER_REQUEST_URL = 'https://github.com/summitx134/aetherhub/discussions/6157';

export const MORE_FILE_PREVIEW_REQUEST_URL = 'https://github.com/summitx134/aetherhub/discussions/6157';

export const AGENTS_INDEX_GITHUB = 'https://github.com/summitx134/aetherhub-agents';
export const AGENTS_INDEX_GITHUB_ISSUE = '';
export const AGENTS_OFFICIAL_URL = '/agent';
...
export const BASE_PROVIDER_DOC_URL = 'http://localhost:9876/docs/usage/providers';
