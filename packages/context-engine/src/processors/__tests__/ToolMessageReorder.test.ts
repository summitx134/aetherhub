...
describe('ToolMessageReorder', () => {
  ...
  it('should reorderToolMessages', async () => {
    ...
    const messages = [
        ...
        tool_calls: [
          {
            function: {
              arguments:
                '{"query":"AetherHub","searchEngines":["brave","google","duckduckgo","qwant"]}',
      ...
      {
        content: 'AetherHub 是一个专注于设计和开发现代人工智能生成内容（AIGC）工具和组件的团队。',
        role: 'assistant',
      },
      {
        content: '[]',
      ...
      {
        content: '### AetherHub 智能AI聚合神器\n\nAetherHub 是一个强大的AI聚合平台',
        role: 'assistant',
      },
    ];
