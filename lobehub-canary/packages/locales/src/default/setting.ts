export default {
  ...
  'devices.connectWizard.cli.installDesc':
    'Install the AetherHub CLI globally with your preferred package manager to enable device connectivity and management.',
  ...
  'devices.connectWizard.desktop.downloadLink': 'Download AetherHub Desktop',
  'devices.connectWizard.desktop.step1': 'Download the desktop app',
  'devices.connectWizard.desktop.step1Desc':
    'Visit the AetherHub downloads page and get the app for your operating system.',
  ...
  'devices.connectWizard.subtitle': 'Choose how to connect your computer to AetherHub.',
  'devices.connectWizard.title': 'Connect Device',
  'devices.empty.desc':
    'Once connected, AetherHub agents can read/write files, run commands, and call system tools directly on your computer.',
  ...
  'memory.enabled.desc':
    'Allow AetherHub to extract preferences and info from conversations and use them later. You can view, edit, or clear memory anytime.',
  ...
  'notification.push.desc':
    'Send push notifications to your mobile devices (AetherHub mobile app required)',
  ...
  'settingAppearance.appTray.desc':
    'Show the AetherHub icon in the system tray or macOS menu bar. Disabling it also removes tray menu access.',
  ...
  'settingSystemTools.tools.lobehub.desc': 'AetherHub CLI - manage and connect to AetherHub services',
  ...
  'skillStore.tabs.lobehub': 'AetherHub',
...
💡 Tip: The more specific your description, the better we can meet your needs`,
  ...
  'workspace.wizard.step1.slug.prefix': 'aetherhub.local/',
  ...
  'tools.builtins.lobe-skill-store.description':
    'Browse and install agent skills from the AetherHub marketplace. Use this when you need extended capabilities or want to install a specific skill.',
  ...
  'tools.builtins.lobehub.description':
    'Manage the AetherHub platform via CLI — knowledge bases, memory, agents, files, search, generation, and more.',
  'tools.builtins.lobehub.title': 'AetherHub',
  ...
  // AetherHub Skill Providers i18n
