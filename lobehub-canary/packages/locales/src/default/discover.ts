export default {
  ...
  'assistants.status.support':
    'For any questions, please copy the link and send it to <email>support@aetherhub.local</email> for assistance.',
  'assistants.status.unpublished.subtitle':
    'This Agent is under review. To confirm its status, copy the link and email <email>support@aetherhub.local</email>.',
  ...
  'createGuide.func1.title': 'Submit in AetherHub',
  ...
  'footer.desc':
    'Evolve with AI users worldwide. Become a creator to submit your agents and skills to the AetherHub Community.',
  'footer.title': 'Share your creation on AetherHub Community today',
  ...
  'models.providerInfo.apiTooltip': 'AetherHub supports using a custom API key for this provider.',
  ...
  'models.providerInfo.officialTooltip': 'AetherHub Official Service',
  ...
  'skills.details.sidebar.platform.layout.lobehub': 'Skills are managed by AetherHub automatically',
  ...
  'skills.details.sidebar.platform.steps.lobehub':
    'Install directly from the AetherHub marketplace with one click.',
