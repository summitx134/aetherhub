import type { AetherHubPluginApi } from '@lobechat/types';

import { SkillsApiName } from './types';

export const activateSkillApi: AetherHubPluginApi = {
  description:
...
export const readReferenceApi: AetherHubPluginApi = {
  description:
...
export const exportFileApi: AetherHubPluginApi = {
  description:
...
export const runCommandApi: AetherHubPluginApi = {
  description:
