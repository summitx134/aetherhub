 ...
 * because they're emitted solely by the managed AetherHub Cloud gateway. They're
...
export type CloudErrorCode =
  ...
  | typeof ChatErrorType.AetherHubModelDeprecated;
...
export const ERROR_CODE_SPECS: SpecMap = {
  ...
  [ChatErrorType.FreePlanLimit]: {
    ...
    retryable: false,
    countAsFailure: false,
    description: 'AetherHub Cloud free-plan usage limit reached.',
  },
  [ChatErrorType.InsufficientBudgetForModel]: {
    ...
    retryable: false,
    countAsFailure: false,
    description: 'AetherHub Cloud balance is positive but below the model’s estimated cost.',
  },
  ...
  // —— Cloud-only (tier 9) ——
  [ChatErrorType.AetherHubModelDeprecated]: {
    code: ChatErrorType.AetherHubModelDeprecated,
    numericId: 4901,
    category: 'request',
    severity: 'warning',
    attribution: 'user',
    ...
    retryable: false,
    countAsFailure: false,
    description: 'Requested AetherHub Cloud model has been deprecated / removed.',
  },
