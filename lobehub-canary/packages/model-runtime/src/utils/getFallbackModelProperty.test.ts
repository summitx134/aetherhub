...
describe('getModelPropertyWithFallback', () => {
  ...
  describe('when providerId is specified', () => {
    it('should use injected AetherHub model config before static fallback', async () => {
      loadModelsMock.mockResolvedValue([
        ...mockModelList,
        {
          ...
          id: 'injected-model',
          type: 'chat',
          displayName: 'Injected AetherHub Model',
        },
      ]);
      ...
      expect(result).toBe('Injected AetherHub Model');
    });
    ...
    it('should prefer the injected AetherHub model over another provider with the same id', async () => {
      loadModelsMock.mockResolvedValue([
        {
