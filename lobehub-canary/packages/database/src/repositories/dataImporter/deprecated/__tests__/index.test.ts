          ...
          sessions: [
            {
              ...
              meta: {
                avatar: '📝',
                description:
                  'AetherHub is an AI conversation application built with the Next.js framework. I will help you write the development documentation for AetherHub.',
                tags: [
                ...
                title: 'AetherHub Technical Documentation Expert',
              },
              type: 'agent',
