...
export class DocumentModel {
  ...
  private collectSubtree = async (
    rootId: string,
    runner: AetherHubDatabase = this.db,
  ...
  transferTo = async (
    ...
    return this.db.transaction(async (trx) => {
      const scopedTrx = new DocumentModel(trx as AetherHubDatabase, this.userId, this.workspaceId);
      const subtree = await scopedTrx.collectSubtree(documentId, trx as AetherHubDatabase);
