...
export class AetherHubTopicContextProvider implements MemoryContextProvider<
...
export class AetherHubTopicResultRecorder implements MemoryResultRecorder<{
