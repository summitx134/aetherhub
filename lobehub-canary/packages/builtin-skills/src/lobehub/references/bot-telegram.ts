...
- **Secret Token** (optional): a custom string you define; AetherHub includes it in webhook requests so you can verify they genuinely come from AetherHub — leave blank unless you have a security requirement
