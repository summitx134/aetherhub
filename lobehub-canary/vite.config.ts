...
import { aetherhubMockApi } from './plugins/vite/mock-api';
  ...
  plugins: [
    ...
    isDev && {
      ...
      configureServer(server: ViteDevServer) {
        const ONLINE_HOST = 'http://localhost:9876';
        const c = {
    ...
    // Mock disabled — using real backend on :3010  isDev && aetherhubMockApi(),
