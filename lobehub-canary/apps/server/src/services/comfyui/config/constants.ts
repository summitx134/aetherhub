...
export const FLUX_MODEL_CONFIG = {
  FILENAME_PREFIXES: {
    DEV: 'AetherHub/%year%-%month%-%day%/FLUX_Dev',
    KONTEXT: 'AetherHub/%year%-%month%-%day%/FLUX_Kontext',
    KREA: 'AetherHub/%year%-%month%-%day%/FLUX_Krea',
    SCHNELL: 'AetherHub/%year%-%month%-%day%/FLUX_Schnell',
  },
} as const;
...
export const SD_MODEL_CONFIG = {
  FILENAME_PREFIXES: {
    CUSTOM: 'AetherHub/%year%-%month%-%day%/CustomSD',
    SD15: 'AetherHub/%year%-%month%-%day%/SD15',
    SD35: 'AetherHub/%year%-%month%-%day%/SD35',
    SDXL: 'AetherHub/%year%-%month%-%day%/SDXL',
  },
} as const;
