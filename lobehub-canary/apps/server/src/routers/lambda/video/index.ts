...
import { isAetherHubModelAvailable } from '@lobechat/business-model-bank/model-config';
import {
  ...
  createVideo: videoCreateProcedure
    ...
    .mutation(async ({ input, ctx }) => {
      ...
      if (
        ...
        !(await isAetherHubModelAvailable(resolvedModelId, 'video', {
        ...
        throw new TRPCError({
          ...
          code: 'BAD_REQUEST',
          message: ChatErrorType.AetherHubModelDeprecated,
        });
      }
