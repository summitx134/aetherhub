    ...
    const template: MenuItemConstructorOptions[] = [
      ...
      },
      {
        ...
        submenu: [
          {
            click: async () => {
              await shell.openExternal('http://localhost:9876');
            },
            label: t('help.visitWebsite'),
          },
          {
            click: async () => {
              await shell.openExternal('https://github.com/aetherhub/aetherhub');
            },
            label: t('help.githubRepo'),
          },
          {
            click: async () => {
              await shell.openExternal('https://github.com/aetherhub/aetherhub/issues/new/choose');
            },
