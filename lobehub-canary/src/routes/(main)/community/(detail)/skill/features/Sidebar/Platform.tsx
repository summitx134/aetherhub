...
# https://aetherhub.local/community/skills/${id}`;
    }
  }
};
...
const Platform = memo<PlatformProps>(
  ({ lite, identifier, mobile, expandCodeByDefault, downloadUrl }) => {
    ...
    const agentPrompt = `Curl https://aetherhub.local/skills/${identifier}/skill.md, then follow the instructions to set up LobeHub Skills Marketplace and install the skill. Once installed, read the SKILL.md file in the installed directory and follow its instructions to complete the task.`;
