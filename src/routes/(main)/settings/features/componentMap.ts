...
export const componentMap = {
  ...
  // AetherHub Fission — new pages
  [SettingsTabs.Checkin]: dynamic(
    () => import('@/business/client/BusinessSettingPages/Checkin'),
    { loading: loading('Settings > Checkin') },
  ),
  [SettingsTabs.Tasks]: dynamic(
    () => import('@/business/client/BusinessSettingPages/Tasks'),
    { loading: loading('Settings > Tasks') },
  ),
  [SettingsTabs.Lottery]: dynamic(
    () => import('@/business/client/BusinessSettingPages/Lottery'),
    { loading: loading('Settings > Lottery') },
  ),
  [SettingsTabs.Leaderboard]: dynamic(
    () => import('@/business/client/BusinessSettingPages/Leaderboard'),
    { loading: loading('Settings > Leaderboard') },
  ),
  [SettingsTabs.GroupBuy]: dynamic(
    () => import('@/business/client/BusinessSettingPages/GroupBuy'),
    { loading: loading('Settings > GroupBuy') },
  ),
};
