...
const NewUserGiftPopup = lazy(() => import('@/business/client/features/Fission/NewUserGiftPopup'));
...
{/* <NewUserGiftPopup /> temporarily disabled for debugging */}
              {/* LobeHub: DevTools disabled for clean demo handoff */}
            </Suspense>
          </ServerConfigStoreProvider>
        </AppTheme>
      </NextThemeProvider>
