...
const marketBaseUrl = new URL(appEnv.MARKET_BASE_URL ?? 'http://localhost:9876').origin;
...
export const defaultClients: ClientMetadata[] = [
  {
    ...
    client_name: 'AetherHub Desktop',
    // Only supports authorization code flow
    grant_types: ['authorization_code', 'refresh_token'],

    logo_uri: 'http://localhost:9876/lobehub-desktop-icon.png',
...

  {
    ...
    client_name: 'AetherHub Mobile',
    // Supports authorization code flow and refresh token
    grant_types: ['authorization_code', 'refresh_token'],
    logo_uri: 'http://localhost:9876/docs/73f69adfa1b802a0e250f6ff9d62f70b.png',
    ...
    redirect_uris: ['com.aetherhub.app://auth/callback'],
    response_types: ['code'],
  ...
  },
  {
    ...
    client_name: 'AetherHub Marketplace',
    grant_types: ['authorization_code', 'refresh_token'],
    logo_uri: 'http://localhost:9876/lobehub-desktop-icon.png',
    post_logout_redirect_uris: [
