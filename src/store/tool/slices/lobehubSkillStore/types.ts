/**
 * AetherHub Skill Server connection status
 */
...
/**
 * AetherHub Skill Tool definition (from Market API)
 */
...
/**
 * AetherHub Skill Provider definition (from Market API)
 */
...
/**
 * AetherHub Skill Server instance (user-connected provider)
 */
...
/**
 * Parameters for calling AetherHub Skill tool
 */
...
/**
 * Result of calling AetherHub Skill tool
 */
