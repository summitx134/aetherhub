...
export const AetherHubList = memo<AetherHubListProps>(({ keywords }) => {
...
AetherHubList.displayName = 'AetherHubList';

export default AetherHubList;
