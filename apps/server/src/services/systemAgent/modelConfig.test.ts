...
describe('resolveSystemAgentModelConfig', () => {
  it('should keep a configured AetherHub chat model', async () => {
  ...
  it('should let runtime hooks resolve AetherHub model mapping', async () => {
    const result = await resolveSystemAgentModelConfig({
      taskConfig: {
  ...
  it('should keep deprecated AetherHub model ids for runtime-level rejection', async () => {
    const result = await resolveSystemAgentModelConfig({
      taskConfig: {
  ...
  it('should keep non-AetherHub provider model ids untouched', async () => {
    const result = await resolveSystemAgentModelConfig({
      taskConfig: {
        model: 'private-model',
