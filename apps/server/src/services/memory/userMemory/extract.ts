...
import {
  ...
  AetherHubTopicContextProvider,
  AetherHubTopicResultRecorder,
  ...
  async extractTopic(job: TopicExtractionJob) {
    ...
    return tracer.startActiveSpan(
      ...
      async (span) => {
        ...
        let resultRecorder: AetherHubTopicResultRecorder | null = null;
        ...
        try {
          ...
          const topicContextProvider = new AetherHubTopicContextProvider({
          ...
          resultRecorder = new AetherHubTopicResultRecorder({
