...
describe('Skill Router Integration Tests', () => {
  let serverDB: AetherHubDatabase;
  ...
  describe('importFromMarket', () => {
    ...
    it('should keep the market identifier stable when re-importing from market', async () => {
      mockMarketServiceInstance.getSkillDownloadUrl
        .mockReturnValueOnce('https://market.aetherhub.local/api/v1/skills/github.owner.repo/download')
        .mockReturnValueOnce(
          'https://market.aetherhub.local/api/v1/skills/github.owner.repo/download?version=1.0.0',
        );
