...
export const getDesktopEnv = memoize(() =>
  createEnv({
    ...
    server: {
      ...
      OFFICIAL_CLOUD_SERVER: z.string().optional().default('http://localhost:9876'),
      ...
      // e.g., https://releases.aetherhub.local/stable or https://your-bucket.s3.amazonaws.com/releases
