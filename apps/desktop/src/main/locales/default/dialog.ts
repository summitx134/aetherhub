const dialog = {
  ...
  'fullDiskAccess.message':
    'AetherHub needs Full Disk Access to read files and enable knowledge base features. Please grant access in System Settings.',
  ...
  'screenCaptureAccess.detail':
    'Open System Settings, enable Screen Recording for AetherHub, then try Quick Composer again.',
